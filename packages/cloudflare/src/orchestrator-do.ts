...
function createEditSystemPrompt(island: EditableIsland): string {
  return [
    ...
    "Use React.createElement calls instead of JSX until the runtime Worker bundler is available.",
    "Do not include TypeScript type annotations. Return plain JavaScript-compatible TSX.",
